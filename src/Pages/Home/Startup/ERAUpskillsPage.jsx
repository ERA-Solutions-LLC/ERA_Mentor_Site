...
const IconWithTextData = [
  {
    ...
    content: "Jumpstart your career in software",
  },
  {
  ...
  },
  {
    ...
    title: "Training Mentorships",
    content: "Learn from the comfort of your home",
  },
]
...
const TabData = [
  {
    tabTitle: 'Mainframe/Broadband Tech',
  ...
  {
    tabTitle: 'Software Developer Cert Training',
    tabicons: "ti-timer",
    img: 'https://via.placeholder.com/800x550',
    title: 'We are idea driven, working with a strong focus on design and user experience.',
    subtitle: 'Transform your ideas. We know that good design means good business.',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, nostrud exercitation ullamco laboris.',
    buttonTitle: "Learn More",
    buttonLink: "https://www.dunderdata.com/erasolutions"
  },
  {
    tabTitle: 'Total Cyber Solutions Courses',
    ...
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, nostrud exercitation ullamco laboris.',
    buttonTitle: "Learn More",
    buttonLink: "https://training.totalcyber.com/"
  },
  {
    tabTitle: 'Web Professional Certifications',
    tabicons: "ti-crown",
    img: 'https://via.placeholder.com/800x550',
    title: 'We are idea driven, working with a strong focus on design and user experience.',
    subtitle: 'Transform your ideas. We know that good design means good business.',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, nostrud exercitation ullamco laboris.',
    buttonTitle: "Learn More",
    buttonLink: "https://www.pinnacletechacademy.com/"
  },
  {
    tabTitle: 'Wordpress Associate Professional',
    tabicons: "ti-crown",
    img: 'https://via.placeholder.com/800x550',
    title: 'We are idea driven, working with a strong focus on design and user experience.',
    subtitle: 'Transform your ideas. We know that good design means good business.',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, nostrud exercitation ullamco laboris.',
    buttonTitle: "Learn More",
    buttonLink: "https://wpconnects.com/"
  },
  {
    tabTitle: 'Broadband/Certification-SCTE',
    tabicons: "ti-crown",
    img: 'https://via.placeholder.com/800x550',
    title: 'We are idea driven, working with a strong focus on design and user experience.',
    subtitle: 'Transform your ideas. We know that good design means good business.',
        ...
        <Container>
          <Row className="justify-center">
            <Col className="text-center" md={7} lg={6} xs={12}>
              <span className="text-basecolor text-lg mb-[15px] md:text-xmd inline-block">Work with groups and mentors to ensure success</span>
