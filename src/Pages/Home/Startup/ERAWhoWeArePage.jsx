  ...
  return (
    <div className="who-we-are" style={props.style}>
              ...
              <Row>
                <Col>
                  <div className="flex">
                    ...
                    <div className="feature-box-content ">
                      <span className="text-darkgray block mb-[10px] font-serif font-medium">Job Placement</span>
                      <p className="w-[95%]">Often, more than one area of expertise is required with providing the right candidate for you. With our business, you will have the best approach in reaching your business goals year after year.</p>
                    </div>
                  </div>
                </Col>
                ...
                <Col>
                  <div className="flex">
                    ...
                    <div className="feature-box-content ">
                      <span className="text-darkgray block mb-[10px] font-serif font-medium">Valued Relationships</span>
                      <p className="w-[95%]">We serve a wide range of clientele, and every client relationship is valued greatly and treated with dignity and respect. Each engagement benefits from the depth and breadth of our expertise.</p>
                    </div>
                  </div>
                </Col>
              </Row>
        ...
        <Container>
          <Row className="items-center justify-center">
            <Col lg={4} sm={8} className="text-center text-lg-start md:mb-[50px]">
              <h6 className="font-serif w-[80%] text-darkgray font-medium mb-[20px] lg:w-[90%] md:w-full md:mb-[10px]">ERA Solutions LLC supports HR and talent firms with building their veteran pipeline</h6>
              <Buttons ariaLabel="button" to="/contact" className="text- font-medium font-serif uppercase btn-link after:h-[2px] md:text-md after:bg-fastblue hover:opacity-70" size="md" color="#0038e3" title="Business solutions" />
            </Col>
            <TextBox
        ...
        <Container>
          <Row className="justify-center">
            <Col lg={7} sm={9} className="relative text-center mb-[4.5rem]">
              <div className="text-xmd text-white mb-[20px] opacity-60 font-serif">Helping your business succeed</div>
              <h5 className="font-serif text-white font-medium mb-10 sm:mb-[30px]">Whether its training you need or a job, we have you covered</h5>
      ...
      <m.div className="relative overflow-hidden py-[140px] lg:py-[90px] md:py-[75px] sm:py-[50px] sm:px-[15px]" {...fadeIn}>
        <Parallax className="lg-no-parallax bg-cover cover-background absolute top-[-30px] left-0 h-[100vh] lg:h-[64vh] lg:top-[-75px] lg:!translate-y-0 md:h-[60vh] md:-top-[30px] sm:top-0 sm:h-[56vh] xs:h-[50vh] w-full" translateY={[-40, 40]} style={{ backgroundColor: "lightgray" }}></Parallax>
        ...
        <Container>
          <Row className="items-center justify-center">
            ...
            <Col lg={6} md={{ span: 8, order: 1 }} className="relative xs:text-center landscape:md:text-center xs:px-0">
              <span className="text-lg font-serif mb-[25px] block text-white opacity-60 md:text-xmd md:leading-[22px]">HR Solutions for Veterans and Businesses Hiring Veterans</span>
              <h4 className="font-serif text-white font-medium mb-[30px]">Let us help your business or career grow</h4>
              <Buttons href="/contact" className="mt-[15px] font-medium rounded-[50px] font-serif uppercase hover:text-darkgray bg-transparent btn-slide-right" size="md" color="#fff" themeColor="#fff" title="Get Started Now" />
            </Col>
          </Row>
        </Container>
      </m.div>
