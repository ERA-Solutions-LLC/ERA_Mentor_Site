      ...
      <Container className="h-full">
        <Row className="items-end justify-center h-full">
          <Col xl={6} lg={7} md={10} className="relative z-[2] text-center">
            <span className="mb-[5px] font-serif text-slate-50 bg-black opacity-60  block">HR Solutions and Training</span>
            <h1 className="text-slate-50 bg-black opacity-60  font-serif font-medium text-[42px] leading-[49px] mb-28 sm:mb-12 sm:text-[30px] sm:leading-[40px] xs:text-[20px]">Era Solutions</h1>
